      ...
      <div className="space-y-5 border-t border-border/70 px-5 py-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <label className="block text-xs">
            ...
            <input
              ...
              className="w-full rounded-md border border-border bg-page px-3 py-2 text-base"
            />
          </label>
        ...
        <div className="rounded-lg border border-border/70 bg-surface-2/30 px-3 py-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md border border-amber-400 bg-amber-50 px-3 py-2 text-sm font-semibold text-amber-900 hover:bg-amber-100 disabled:cursor-not-allowed disabled:opacity-50"
          >
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-md border border-sky-400 bg-sky-100 px-3 py-1.5 text-xs font-semibold text-sky-900 hover:bg-sky-200 disabled:cursor-not-allowed disabled:opacity-50"
                    >
...
function OtherDamageForm({
  ...
  if (!open) {
    return (
      <button
        ...
        className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-text-muted underline-offset-2 hover:underline disabled:cursor-not-allowed disabled:opacity-50"
      >
  ...
  return (
    <div className="mt-2 rounded-lg border border-amber-200 bg-amber-50/60 px-3 py-3 space-y-2">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="rounded-md border border-amber-400 bg-amber-100 px-3 py-1.5 text-xs font-semibold text-amber-900 hover:bg-amber-200 disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        <button
          ...
          className="rounded-md border border-border bg-surface px-3 py-1.5 text-xs text-text-muted hover:bg-page"
        >
          Cancel
        </button>
      </div>
